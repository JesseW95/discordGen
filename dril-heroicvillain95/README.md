...
| --- | --- | --- |
| Tweets downloaded | 3226 | 2491 |
| Retweets | 472 | 134 |
| Short tweets | 304 | 337 |
| Tweets kept | 2450 | 2020 |

[Explore the data](https://wandb.ai/wandb/huggingtweets/runs/34mzz84k/artifacts), which is tracked with [W&B artifacts](https://docs.wandb.com/artifacts) at every step of the pipeline.

## Training procedure

The model is based on a pre-trained [GPT-2](https://huggingface.co/gpt2) which is fine-tuned on @dril-heroicvillain95's tweets.

Hyperparameters and metrics are recorded in the [W&B training run](https://wandb.ai/wandb/huggingtweets/runs/2yfrrpib) for full transparency and reproducibility.

At the end of training, [the final model](https://wandb.ai/wandb/huggingtweets/runs/2yfrrpib/artifacts) is logged and versioned.
